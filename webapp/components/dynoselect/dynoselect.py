...
class Dynoselect(rx.ComponentState):
    ...
    def get_component(
        ...
        def hoverable(child, idx: int, info: str, **props) -> rx.Component:
            btn = rx.tooltip(
                    rx.button(
                    child, display="inline", variant="solid", size=size,
                    style={
                        ":not(:hover)":{"background": "transparent", "color": "black"},
...
dynoselect_custom = Dynoselect.create
