function DataStruct = PLSPrediction(k,DataStruct)
        ...
        DataStruct.yPLS = DataStruct.xPLS * DataStruct.bPLS;
        ...
        %DataStruct.explanationPLS = VarianceExplanation(PCTVAR);
        DataStruct = EvaluateRecurrentPLS(DataStruct); % Evaluate the recurrent PLS network for the training set
end
