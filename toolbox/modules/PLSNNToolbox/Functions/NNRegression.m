function DataStruct = NNRegression(k,DataStruct)
        DataStruct.xNameData = transpose(DataStruct.xNameData);
        DataStruct = Training(k,DataStruct); % Train the data for the NN 
        DataStruct.yNN = transpose(DataStruct.yNN);
end
% **************************************************************************** 
% Training Algorithms
% **************************************************************************** 
function DataStruct = Training(k,DataStruct) % Train the data set
