function PlotTiledFigureB(ax2,xD,yD,yLR,yPLS,yNN,titlePlot,legendOn,xLabel,yLabel,xLim,yLim,markerSize) % Theory and Simulation Plot, one phosphosite
        ...
        % Boilerplate
        titlePlot = "NN Model of RASi Alone";
        legendOn = false;
        pbaspect([3 3 1]);
        xlim(xLim);
        ylim(yLim);
